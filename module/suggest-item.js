...
var SuggestItem = function (_React$Component) {
  ...
  _createClass(SuggestItem, [{
    ...
    value: function scrollIfNeeded() {
      ...
      var overTop = el.offsetTop - parent.offsetTop < parent.scrollTop;
      var overBottom = el.offsetTop - parent.offsetTop + el.clientHeight > parent.scrollTop + parent.clientHeight;
